...
#Original log format
# ----------------------------------------------------------------------------------------------------------------------------------------
# May 10 09:00:04 app1     postfix/cleanup[16235]: 2FF22618A7: message-id=<20210510090004.2FF22618A7@app1.localdomain>
# ----------------------------------------------------------------------------------------------------------------------------------------
#
...
x=($(cat $1 | awk '{print $1, "^"$2, "^"$3, "^"$4}'))
y=($(cat $1 | awk '{first = $1; $1 = ""; second = $2; $2 = "" ; third = $3; $3 = ""; fourth = $4; $4 = ""; print "^"$0 }'))
loop=${#x[*]}
for ((z=0; z<=$loop; z++))
do
