...
# Multi Layer instance Patching (image replace)
...
Layer_IDs=$( aws opsworks --region $REGION describe-layers --stack-id  $StackId --query Layers[*].LayerId[] --output text )
